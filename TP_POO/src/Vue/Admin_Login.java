...
class Admin_Login extends JFrame {
    public Admin_Login() {
        ...
        ImageIcon backgroundImage = new ImageIcon("image3.png");
        ...
        JPanel mainPanel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g2d.fillRoundRect(0, 0, getWidth(), getHeight(), 40, 40); // More rounded corners
                g2d.dispose();
            }
        };
...
// Add this line to make the panel transparent
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        JLabel codeLabel = new JLabel("ID:");
        ...
        loginButton.setPreferredSize(new Dimension(80, 30)); // Smaller size
